...
import (
	...
	credentialMocks "github.com/satimoto/go-ocpi-api/credential/v2.1.1/mocks"
...
func TestCreateCredentialPayload(t *testing.T) {
	...
	t.Run("Create payload", func(t *testing.T) {
		...
		credentialResolver := credentialMocks.NewResolver(mockRepository, utilMocks.NewOCPIRequester(mockHTTPRequester))
